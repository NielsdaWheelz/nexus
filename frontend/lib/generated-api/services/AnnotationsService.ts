...
import type { AnnotationListResponse } from "../models/AnnotationListResponse";
...
export class AnnotationsService {
  /**
   * Create annotation
   * Create a new annotation on a highlight or chunk.
   * @param requestBody
   * @param authorization
   ...
   * @param authorization
   * @returns AnnotationListResponse Successful Response
   * @throws ApiError
   */
  public static listDocumentAnnotationsDocumentsDocumentIdAnnotationsGet(
    ...
    cursor?: string | null,
    authorization?: string | null
  ): CancelablePromise<AnnotationListResponse> {
    return __request(OpenAPI, {
      method: "GET",
